...
* v0.2.8  - Autodiscover Google Merchant and handle utm's with only src.
* v0.2.7  - Return platform info after setting.
* v0.2.6  - Catch xenon End User ID updates from UTM query params.
* v0.2.5  - Version update
* v0.2.4  - Counts now include SKUs and Platforms - finished
...
* v0.1.47 - support running in Shopify web pixel
...
<head>
  <meta charset="utf-8">
  <script src="https://cdn.jsdelivr.net/gh/xenonview-com/view-js-sdk@v0.2.10/dist/xenon_view_sdk.min.js"></script>
  <script>
    Xenon.init('<API KEY>')
  </script>
  <title>Sample</title>
...
>[!TIP] 
If linking between Xenon enabled sites, you can pass along the End User ID by 
specifying a UTM parameter with the ID in the form, for example if End User ID 
was "1234-5678": ```?xenon_euid=1234-5678```
